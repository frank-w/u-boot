 ...
 */
static const char *mt7988_jtag_groups[] = { "tops_jtag0_0", "wo0_jtag", "wo1_jtag",
	"wo2_jtag", "jtag", "tops_jtag0_1", };
static const char *mt7988_int_usxgmii_groups[] = { "int_usxgmii", };
static const char *mt7988_pwm_groups[] = { "pwm0", "pwm1", "pwm2", "pwm3",
	"pwm4", "pwm5", "pwm6", "pwm7" };
static const char *mt7988_dfd_groups[] = { "dfd", };
static const char *mt7988_i2c_groups[] = { "xfi_phy0_i2c0", "xfi_phy1_i2c0",
	"xfi_phy_pll_i2c0",	"xfi_phy_pll_i2c1", "i2c0_0", "i2c1_sfp", "xfi_pextp_phy0_i2c",
...
static const char *mt7988_ethernet_groups[] = { "mdc_mdio0", "2p5g_ext_mdio",
	"gbe_ext_mdio", "mdc_mdio1", };
static const char *mt7988_pcie_groups[] = { "pcie_wake_n0_0", "pcie_clk_req_n0_0",
	"pcie_wake_n3_0", "pcie_clk_req_n3", "pcie_p0_phy_i2c", "pcie_p1_phy_i2c",
	"pcie_p3_phy_i2", "pcie_p2_phy_i2c", "ckm_phy_i2c", "pcie_wake_n0_1",
	"pcie_wake_n3_1", "pcie_2l_0_pereset", "pcie_1l_1_pereset", "pcie_clk_req_n2_1",
	"pcie_2l_1_perese", "pcie_1l_0_pereset", "pcie_wake_n1_0", "cie_clk_req_n1",
	"pcie_wake_n2_0", "pcie_wake_n2_1", };
static const char *mt7988_pmic_groups[] = { "pmic", };
static const char *mt7988_wdt_groups[] = { "watchdog", };
static const char *mt7988_spi_groups[] = { "spi0", "spi0_wp_hold", "spi1", "spi2",
	"spi2_wp_hold", };
static const char *mt7988_flash_groups[] = { "emmc_45", "snfi", "emmc_51" };
...
static const char *mt7988_udi_groups[] = { "udi", };
static const char *mt7988_pcm_groups[] = { "pcm", };
static const char *mt7988_led_groups[] = { "gbe_led1", "2p5gbe_led1", "gbe_led0",
	"2p5gbe_led0", "wf5g_led0", "wf5g_led1", };
static const char *mt7988_usb_groups[] = { "drv_vbus", "drv_vbus_p1", };

static const struct mtk_function_desc mt7988_functions[] = {
	{"jtag", mt7988_jtag_groups, ARRAY_SIZE(mt7988_jtag_groups)},
	{"int_usxgmii",	mt7988_int_usxgmii_groups, ARRAY_SIZE(mt7988_int_usxgmii_groups)},
...
static struct mtk_pinctrl_soc mt7988_data = {
	.name = "mt7988_pinctrl",
