...
#ifdef MTK_ANTI_ROLLBACK
static uintptr_t apsoc_sip_get_ar_ver(uint32_t smc_fid, u_register_t x1,
				      u_register_t x2, u_register_t x3,
				      u_register_t x4, void *cookie,
				      void *handle, u_register_t flags)
{
	...
	ret = mtk_ar_get_ar_ver((uint32_t)x1, &ar_ver);
	SMC_RET2(handle, ret, ar_ver);
}

static uintptr_t apsoc_sip_update_ar_ver(uint32_t smc_fid, u_register_t x1,
					 u_register_t x2, u_register_t x3,
					 u_register_t x4, void *cookie,
					 void *handle, u_register_t flags)
{
	...
	ret = mtk_ar_update_ar_ver((uint32_t)x1, (uint32_t)x2);
	SMC_RET1(handle, ret);
}

static uintptr_t apsoc_sip_lock_ar_ver(uint32_t smc_fid, u_register_t x1,
				       u_register_t x2, u_register_t x3,
				       u_register_t x4, void *cookie,
				       void *handle, u_register_t flags)
{
...
#endif
#ifdef MTK_ANTI_ROLLBACK
	MTK_SIP_CALL_RECORD(MTK_SIP_GET_AR_VER, apsoc_sip_get_ar_ver),
	MTK_SIP_CALL_RECORD(MTK_SIP_UPDATE_AR_VER, apsoc_sip_update_ar_ver),
	MTK_SIP_CALL_RECORD(MTK_SIP_LOCK_AR_VER, apsoc_sip_lock_ar_ver),
#endif
};
