...
/*
 * MTK_SIP_FW_DEC_CLEANUP - Cleanup the environment for firmware encryption
 *
 * parameters
 *
 * return
...
/*
 * MTK_SIP_GET_AR_VER - get anti-rollback version
 *
 * parameters
 * @x1:		version id
 *
...
/*
 * MTK_SIP_UPDATE_AR_VER - update anti-rollback version
 *
 * parameters
 * @x1:		version id
 * @x2:		version
...
/*
 * MTK_SIP_LOCK_AR_VER - lock anti-rollback version update
 *
 * parameters
 *
 * return
