...
ifeq ($(FPGA), 1)
PLAT_INCLUDES		+=	-I${MTK_PLAT_SOC}/drivers/dram/fpga/

BL2_SOURCES		+=	${MTK_PLAT_SOC}/drivers/dram/fpga/memory.c		\
				${MTK_PLAT_SOC}/drivers/dram/fpga/dram_lp2_fpga.c
else
...
#					${MTK_PLAT_SOC}/drivers/dram/common/emi_fake_engine.c
#					${MTK_PLAT_SOC}/drivers/dram/common/Latency_algorithm.c
#					${MTK_PLAT_SOC}/drivers/dram/common/emi_fake_engine.c
#					${MTK_PLAT_SOC}/drivers/dram/common/fake_engine.c
#					${MTK_PLAT_SOC}/drivers/dram/pcddr_cal/low_power_test.c
endif # END OF HAVE_DRAM_OBJ_FILE
endif

ifeq ($(FPGA), 1)
CPPFLAGS		+=	-DMT7981_FPGA
CPPFLAGS		+=	-DFPGA
endif
