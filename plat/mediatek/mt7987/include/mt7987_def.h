...
#define EMI_MPU_APC(region, dgroup)	(EMI_MPU_APC0 + (region) * 4 + \
					 (dgroup) * 0x100)
#define EMI_MPU_DOM_REMAP_TBL0		(EMI_MPU_APB_BASE + 0x008)
...
/* TOP_CLOCK*/
#define CLK_CFG_2			(TOPCKGEN_BASE + 0x020)

#define CLK_CFG_2_SET			(TOPCKGEN_BASE + 0x024)
#define CLK_SPI_SEL_S			8
#define CLK_NFI1X_SEL_S			16
#define CLK_SPINFI_BCLK_SEL_S		24

#define CLK_CFG_2_CLR			(TOPCKGEN_BASE + 0x028)
#define CLK_SPI_SEL_MASK		GENMASK(10, 8)
